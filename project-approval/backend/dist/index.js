...
var functionApply$1 = typeof Reflect == 'object' && Reflect.apply || (NATIVE_BIND$3 ? call$c.bind(apply$1) : function () {
...
var classofRaw$2 = function (it) {
  return stringSlice$3(toString$b(it), 8, -1);
};
...
var descriptors$2 = !fails$d(function () {
...
// eslint-disable-next-line es/no-function-prototype-bind -- safe
var functionCall$1 = NATIVE_BIND$1 ? call$a.bind(call$a) : function () {
...
var indexedObject = fails$c(function () {
  ...
  return classof$8(it) === 'String' ? split$3(it, '') : $Object$5(it);
} : $Object$5;
...
var getBuiltIn$6 = function (namespace, method) {
  return arguments.length < 2 ? aFunction(path$4[namespace]) || aFunction(globalThis$n[namespace])
    : path$4[namespace] && path$4[namespace][method] || globalThis$n[namespace] && globalThis$n[namespace][method];
};
...
var userAgent$4 = navigator$1 && navigator$1.userAgent;
...
var $String$3 = globalThis$k.String;
...
var isSymbol$3 = USE_SYMBOL_AS_UID$1 ? function (it) {
  ...
  return isCallable$b($Symbol) && isPrototypeOf$3($Symbol.prototype, $Object$4(it));
};
...
var ordinaryToPrimitive$1 = function (input, pref) {
  var fn, val;
  if (pref === 'string' && isCallable$9(fn = input.toString) && !isObject$9(val = call$9(fn, input))) return val;
  if (isCallable$9(fn = input.valueOf) && !isObject$9(val = call$9(fn, input))) return val;
  if (pref !== 'string' && isCallable$9(fn = input.toString) && !isObject$9(val = call$9(fn, input))) return val;
...
var hasOwnProperty_1 = Object.hasOwn || function hasOwn(it, key) {
  return hasOwnProperty$7(toObject$5(it), key);
};
...
var toString$a = uncurryThis$d(1.1.toString);
...
var wellKnownSymbol$a = function (name) {
  if (!hasOwn$c(WellKnownSymbolsStore, name)) {
    WellKnownSymbolsStore[name] = NATIVE_SYMBOL && hasOwn$c(Symbol$3, name)
      ? Symbol$3[name]
...
var bind$8 = uncurryThis$c(uncurryThis$c.bind);
...
var _export = function (options, source) {
  ...
  var target = GLOBAL ? path$3 : path$3[TARGET] || createNonEnumerableProperty$3(path$3, TARGET, {})[TARGET];
  ...
  for (key in source) {
    ...
    if (options.bind && USE_NATIVE) resultProperty = bind$7(sourceProperty, globalThis$f);
    // wrap global constructors for prevent changes in this version
    else if (options.wrap && USE_NATIVE) resultProperty = wrapConstructor(sourceProperty);
    // make static versions for prototype methods
    else if (PROTO && isCallable$7(sourceProperty)) resultProperty = uncurryThis$b(sourceProperty);
    // default case
    ...
    if (PROTO) {
      ...
      if (!hasOwn$a(path$3, VIRTUAL_PROTOTYPE)) {
        createNonEnumerableProperty$3(path$3, VIRTUAL_PROTOTYPE, {});
      }
      // export virtual prototype methods
      createNonEnumerableProperty$3(path$3[VIRTUAL_PROTOTYPE], key, sourceProperty);
...
$$8({ global: true, forced: globalThis$e.globalThis !== globalThis$e }, {
  globalThis: globalThis$e
});

var globalThis$d = globalThis_1;

var parent$7 = globalThis$d;

var globalThis$c = parent$7;

var parent$6 = globalThis$c;

var globalThis$b = parent$6;

// TODO: remove from `core-js@4`


var parent$5 = globalThis$b;

var globalThis$a = parent$5;

var globalThis$9 = globalThis$a;

var globalThis$8 = globalThis$9;

var _globalThis = /*@__PURE__*/getDefaultExportFromCjs$1(globalThis$8);

const getBrowserStoreInfo = () => {
  const env = window;
  const state = env.__ONES_MF_ENV__.store.getState();
  const {
    innerInfoStore,
    contextStore
  } = state;
  ...
  const result = {
    ...
    organizationUUID: organizationInfo.uuid
  };
  return result;
};
const isNode$1 = () => {
...
const isBackend = isNode$1;
const getONESEnv = (key) => {
  return new Promise((resolve) => {
    try {
      if (isBackend()) {
        resolve(`${_globalThis.onesEnv[key] || ""}`);
      } else {
        resolve(`${getBrowserStoreInfo()[key] || ""}`);
      }
    } catch (error) {
      resolve("");
    }
...
const getPlatformApiHost = () => {
  return getONESEnv("platformApiHost");
};
const getPlatformAPIHost = getPlatformApiHost;
const getInstanceId = () => {
  return getONESEnv("instanceId");
};
...
var objectKeysInternal = function (object, names) {
  ...
  var result = [];
  var key;
  for (key in O) !hasOwn$7(hiddenKeys$1, key) && hasOwn$7(O, key) && push$4(result, key);
...
var setToStringTag$5 = function (it, TAG, STATIC, SET_METHOD) {
  ...
  if (target) {
    ...
    if (SET_METHOD && !TO_STRING_TAG_SUPPORT) {
      createNonEnumerableProperty(target, 'toString', toString$9);
    }
  }
};
...
$$6({ target: 'String', stat: true, arity: 1, forced: INCORRECT_LENGTH }, {
  ...
  fromCodePoint: function fromCodePoint(x) {
    ...
    while (length > i) {
      code = +arguments[i];
      if (toAbsoluteIndex(code, 0x10FFFF) !== code) throw new $RangeError$2(code + ' is not a valid code point');
...
var safeGetBuiltIn$1 = function (name) {
  if (!DESCRIPTORS$6) return globalThis$5[name];
...
var serialize = function (it) {
  return replace$2(encodeURIComponent$2(it), find, replacer);
};
...
$$5({ global: true, constructor: true, forced: !USE_NATIVE_URL$3 }, {
...
var createMethod$1 = function (CONVERT_TO_STRING) {
  return function ($this, pos) {
    var S = toString$7(requireObjectCoercible($this));
...
var isArrayIteratorMethod$1 = function (it) {
  return it !== undefined && (Iterators.Array === it || ArrayPrototype$2[ITERATOR] === it);
};
...
var INCORRECT_TO_STRING = !constructorRegExp.test(noop$4);

var isConstructorModern = function isConstructor(argument) {
  if (!isCallable(argument)) return false;
  try {
    construct(noop$4, [], argument);
    return true;
  } catch (error) {
    return false;
  }
...
var arraySetLength = SILENT_ON_NON_WRITABLE_LENGTH_SET ? function (O, length) {
  if (isArray$5(O) && !getOwnPropertyDescriptor(O, 'length').writable) {
...
var stringPunycodeToAscii = function (input) {
  ...
  for (i = 0; i < labels.length; i++) {
    label = labels[i];
    push$2(encoded, exec$1(regexNonASCII, label) ? 'xn--' + encode$4(label) : label);
  }
...
var URLSearchParams$3 = URLSearchParamsModule.URLSearchParams;
  ...
  while (chr()) {
    ...
    if (chr() === '.') {
      ...
      while (chr()) {
        ...
        if (!exec(DIGIT$2, chr())) return;
        while (exec(DIGIT$2, chr())) {
...
var percentEncode = function (chr, set) {
  ...
  return code >= 0x20 && code < 0x7F && !hasOwn$3(set, chr) ? chr : chr === "'" && hasOwn$3(set, chr) ? '%27' : encodeURIComponent$1(chr);
};
...
var isWindowsDriveLetter = function (string, normalized) {
  var second;
  return string.length === 2 && exec(ALPHA$2, charAt(string, 0))
...
var URLState = function (url, isBase, base) {
  ...
  if (isBase) {
    ...
    if (failure) throw new TypeError$1(failure);
    searchParams = getInternalSearchParamsState(new URLSearchParams$3());
...
if (NativeURL) {
  ...
  if (nativeCreateObjectURL) defineBuiltIn(URLConstructor, 'createObjectURL', bind$4(nativeCreateObjectURL, NativeURL));
  // `URL.revokeObjectURL` method
  // https://developer.mozilla.org/en-US/docs/Web/API/URL/revokeObjectURL
  if (nativeRevokeObjectURL) defineBuiltIn(URLConstructor, 'revokeObjectURL', bind$4(nativeRevokeObjectURL, NativeURL));
}

setToStringTag$1(URLConstructor, 'URL');

$$4({ global: true, constructor: true, forced: !USE_NATIVE_URL$2, sham: !DESCRIPTORS }, {
  URL: URLConstructor
});
...
var URL$4 = getBuiltIn$1('URL');

// https://github.com/nodejs/node/issues/47505
// https://github.com/denoland/deno/issues/18893
var THROWS_WITHOUT_ARGUMENTS = USE_NATIVE_URL$1 && fails$2(function () {
  URL$4.canParse();
});
...
var WRONG_ARITY = fails$2(function () {
  return URL$4.canParse.length !== 1;
});
...
$$3({ target: 'URL', stat: true, forced: !THROWS_WITHOUT_ARGUMENTS || WRONG_ARITY }, {
  canParse: function canParse(url) {
    ...
    try {
      return !!new URL$4(urlString, base);
    } catch (error) {
      return false;
    }
  }
...
var $URL = /*@__PURE__*/getDefaultExportFromCjs$1(url$2);
 ...
 */
const isUndefined$2 = typeOfTest$1('undefined');
 ...
 */
const isString$3 = typeOfTest$1('string');
 ...
 */
const isStream$1 = (val) => isObject$2(val) && isFunction$4(val.pipe);
...
const isContextDefined$1 = (context) => !isUndefined$2(context) && context !== _global$1;
...
const hasOwnProperty$6 = (({hasOwnProperty}) => (obj, prop) => hasOwnProperty.call(obj, prop))(Object.prototype);
...
const isThenable$1 = (thing) =>
  thing && (isObject$2(thing) || isFunction$4(thing)) && isFunction$4(thing.then) && isFunction$4(thing.catch);
...
var utils$1 = {
  ...
  hasOwnProp: hasOwnProperty$6, // an alias to avoid ESLint no-prototype-builtins detection
...
utils$1.inherits(AxiosError$3, Error, {
...
var esSetTostringtag = function setToStringTag(object, value) {
	...
	if (
		...
		throw new $TypeError$2('if provided, the `overrideIfSet` and `nonConfigurable` options must be booleans');
	}
...
var parseUrl$4 = require$$0$1.parse;
var fs = require$$6;
...
FormData$2.prototype.submit = function (params, cb) {
  ...
  if (typeof params === 'string') {
    params = parseUrl$4(params); // eslint-disable-line no-param-reassign
    /* eslint sort-keys: 0 */
    options = populate({
      port: params.port,
...
var FormData$3 = /*@__PURE__*/getDefaultExportFromCjs$1(form_data);
  ...
  function defaultVisitor(value, key, path) {
    ...
    if (value && !path && typeof value === 'object') {
      if (utils$1.endsWith(key, '{}')) {
        ...
        (utils$1.isArray(value) && isFlatArray$1(value)) ||
...
var InterceptorManager$3 = InterceptorManager$2;
...
var URLSearchParams$2 = require$$0$1.URLSearchParams;
...
function toURLEncodedForm$1(data, options) {
  return toFormData$3(data, new platform$1.classes.URLSearchParams(), Object.assign({
...
utils$1.reduceDescriptors(AxiosHeaders$3.prototype, ({value}, key) => {
...
utils$1.freezeMethods(AxiosHeaders$3);

var AxiosHeaders$4 = AxiosHeaders$3;
...
utils$1.inherits(CanceledError$3, AxiosError$3, {
  __CANCEL__: true
});
...
var parseUrl$3 = require$$0$1.parse;
...
var stringEndsWith$1 = String.prototype.endsWith || function(s) {
 ...
 */
function getProxyForUrl$1(url) {
  var parsedUrl = typeof url === 'string' ? parseUrl$3(url) : url || {};
  ...
  if (!shouldProxy$1(hostname, port)) {
 ...
 * @private
 */
function shouldProxy$1(hostname, port) {
  var NO_PROXY =
  ...
  return NO_PROXY.split(/[,\s]/).every(function(proxy) {
    ...
    return !stringEndsWith$1.call(hostname, parsedProxyHostname);
  });
}
...
var getProxyForUrl_1$1 = getProxyForUrl$1;

var followRedirects$3 = {exports: {}};
...
var useNativeURL$1 = false;
try {
  assert$1(new URL$2(""));
}
catch (error) {
  useNativeURL$1 = error.code === "ERR_INVALID_URL";
}
...
var InvalidUrlError$1 = createErrorType$1(
  "ERR_INVALID_URL",
  "Invalid URL",
  TypeError
);
var RedirectionError$1 = createErrorType$1(
  "ERR_FR_REDIRECTION_FAILURE",
  "Redirected request failed"
);
var TooManyRedirectsError$1 = createErrorType$1(
  "ERR_FR_TOO_MANY_REDIRECTS",
  "Maximum number of redirects exceeded",
  RedirectionError$1
);
var MaxBodyLengthExceededError$1 = createErrorType$1(
  "ERR_FR_MAX_BODY_LENGTH_EXCEEDED",
  "Request body larger than maxBodyLength limit"
);
var WriteAfterEndError$1 = createErrorType$1(
  "ERR_STREAM_WRITE_AFTER_END",
  "write after end"
);

// istanbul ignore next
var destroy$1 = Writable$1.prototype.destroy || noop$2;
...
function RedirectableRequest$1(options, responseCallback) {
  ...
  this._onNativeResponse = function (response) {
    try {
      ...
      self.emit("error", cause instanceof RedirectionError$1 ?
        cause : new RedirectionError$1({ cause: cause }));
    }
  };
...
RedirectableRequest$1.prototype.abort = function () {
  destroyRequest$1(this._currentRequest);
  this._currentRequest.abort();
  this.emit("abort");
};

RedirectableRequest$1.prototype.destroy = function (error) {
  destroyRequest$1(this._currentRequest, error);
  destroy$1.call(this, error);
  return this;
};
...
RedirectableRequest$1.prototype.write = function (data, encoding, callback) {
  ...
  if (!isString$2(data) && !isBuffer$2(data)) {
...
RedirectableRequest$1.prototype._sanitizeOptions = function (options) {
  ...
  if (!isArray$3(options.sensitiveHeaders)) {
...
RedirectableRequest$1.prototype._processResponse = function (response) {
  ...
  if (++this._redirectCount > this._options.maxRedirects) {
    throw new TooManyRedirectsError$1();
  }
  ...
  spreadUrlObject$1(redirectUrl, this._options);
  ...
  if (redirectUrl.protocol !== currentUrlParts.protocol &&
     ...
     !isSubdomain$1(redirectUrl.host, currentHost)) {
    removeMatchingHeaders$1(this._headerFilter, this._options.headers);
  }
...
function wrap$1(protocols) {
  ...
  Object.keys(protocols).forEach(function (scheme) {
    ...
    function request(input, options, callback) {
      ...
      if (isURL$1(input)) {
        input = spreadUrlObject$1(input);
      }
      else if (isString$2(input)) {
        input = spreadUrlObject$1(parseUrl$2(input));
      }
      else {
        callback = options;
...
function parseUrl$2(input) {
  ...
  if (useNativeURL$1) {
    ...
    if (!isString$2(parsed.protocol)) {
      throw new InvalidUrlError$1({ input });
    }
  }
  return parsed;
}
...
function resolveUrl$1(relative, base) {
  // istanbul ignore next
  return useNativeURL$1 ? new URL$2(relative, base) : parseUrl$2(url$1.resolve(base, relative));
}

function validateUrl$1(input) {
  if (/^\[/.test(input.hostname) && !/^\[[:0-9a-f]+\]$/i.test(input.hostname)) {
    throw new InvalidUrlError$1({ input: input.href || input });
  }
...
function spreadUrlObject$1(urlObject, target) {
  var spread = target || {};
  for (var key of preservedUrlFields$1) {
...
function createErrorType$1(code, message, baseClass) {
  ...
  function CustomError(properties) {
    // istanbul ignore else
    if (isFunction$3(Error.captureStackTrace)) {
      Error.captureStackTrace(this, this.constructor);
    }
...
function destroyRequest$1(request, error) {
  for (var event of events$1) {
...
function isSubdomain$1(subdomain, domain) {
...
// Exports
followRedirects$3.exports = wrap$1({ http: http$1, https: https$1 });
followRedirects$3.exports.wrap = wrap$1;

var followRedirectsExports$1 = followRedirects$3.exports;
var followRedirects$2 = /*@__PURE__*/getDefaultExportFromCjs$1(followRedirectsExports$1);
...
const DATA_URL_PATTERN$1 = /^(?:([^;]+);)?(?:[^;]+;)?(base64|),([\s\S]*)$/;
 ...
 * @returns {Buffer|Blob}
 */
function fromDataURI$1(uri, asBlob, options) {
  const _Blob = options && options.Blob || platform$1.classes.Blob;
  const protocol = parseProtocol$1(uri);
  ...
  if (protocol === 'data') {
    ...
    const match = DATA_URL_PATTERN$1.exec(uri);

    if (!match) {
      throw new AxiosError$3('Invalid URL', AxiosError$3.ERR_INVALID_URL);
    }
    ...
    if (asBlob) {
      if (!_Blob) {
        throw new AxiosError$3('Blob is not supported', AxiosError$3.ERR_NOT_SUPPORT);
      }
  ...
  throw new AxiosError$3('Unsupported protocol ' + protocol, AxiosError$3.ERR_NOT_SUPPORT);
}
...
let AxiosTransformStream$2 = class AxiosTransformStream extends stream.Transform{
  constructor(options) {
    options = utils$1.toFlatObject(options, {
      maxRate: 0,
      chunkSize: 64 * 1024,
    ...
    const internals = this[kInternals$1] = {
    ...
    const _speedometer = speedometer$1(internals.ticksRate * options.samplesCount, internals.timeWindow);
  ...
  setLength(length) {
    this[kInternals$1].length = +length;
    return this;
  }
};

var AxiosTransformStream$3 = AxiosTransformStream$2;

const {asyncIterator: asyncIterator$1} = Symbol;

const readBlob$2 = async function* (blob) {
  if (blob.stream) {
    yield* blob.stream();
...
var readBlob$3 = readBlob$2;

const BOUNDARY_ALPHABET$1 = utils$1.ALPHABET.ALPHA_DIGIT + '-_';

const textEncoder$1 = new require$$1.TextEncoder();

const CRLF$1 = '\r\n';
const CRLF_BYTES$1 = textEncoder$1.encode(CRLF$1);
const CRLF_BYTES_COUNT$1 = 2;

let FormDataPart$1 = class FormDataPart {
  constructor(name, value) {
    ...
    if (isStringValue) {
      value = textEncoder$1.encode(String(value).replace(/\r?\n|\r\n?/g, CRLF$1));
    } else {
      headers += `Content-Type: ${value.type || "application/octet-stream"}${CRLF$1}`;
    }

    this.headers = textEncoder$1.encode(headers + CRLF$1);

    this.contentLength = isStringValue ? value.byteLength : value.size;

    this.size = this.headers.byteLength + this.contentLength + CRLF_BYTES_COUNT$1;
...
const formDataToStream$2 = (form, headersHandler, options) => {
  const {
    tag = 'form-data-boundary',
    size = 25,
    boundary = tag + '-' + utils$1.generateString(size, BOUNDARY_ALPHABET$1)
  } = options || {};
  ...
  const boundaryBytes = textEncoder$1.encode('--' + boundary + CRLF$1);
  const footerBytes = textEncoder$1.encode('--' + boundary + '--' + CRLF$1 + CRLF$1);
  let contentLength = footerBytes.byteLength;

  const parts = Array.from(form.entries()).map(([name, value]) => {
    const part = new FormDataPart$1(name, value);
...
var formDataToStream$3 = formDataToStream$2;

let ZlibHeaderTransformStream$2 = class ZlibHeaderTransformStream extends stream.Transform {
...
var ZlibHeaderTransformStream$3 = ZlibHeaderTransformStream$2;

const callbackify$2 = (fn, reducer) => {
...
var callbackify$3 = callbackify$2;
...
const brotliOptions$1 = {
  flush: zlib.constants.BROTLI_OPERATION_FLUSH,
  finishFlush: zlib.constants.BROTLI_OPERATION_FLUSH
};

const isBrotliSupported$1 = utils$1.isFunction(zlib.createBrotliDecompress);

const {http: httpFollow$1, https: httpsFollow$1} = followRedirects$2;

const isHttps$1 = /https:?/;

const supportedProtocols$1 = platform$1.protocols.map(protocol => {
  return protocol + ':';
});
 ...
 */
function dispatchBeforeRedirect$1(options) {
 ...
 */
function setProxy$1(options, configProxy, location) {
  let proxy = configProxy;
  if (!proxy && proxy !== false) {
    const proxyUrl = getProxyForUrl_1$1(location);
    if (proxyUrl) {
  ...
  options.beforeRedirects.proxy = function beforeRedirect(redirectOptions) {
    ...
    setProxy$1(redirectOptions, configProxy, redirectOptions.href);
  };
}

const isHttpAdapterSupported$1 = typeof process !== 'undefined' && utils$1.kindOf(process) === 'process';
...
var httpAdapter$2 = isHttpAdapterSupported$1 && function httpAdapter(config) {
  return wrapAsync$1(async function dispatchHttpRequest(resolve, reject, onDone) {
    ...
    if (lookup && utils$1.isAsyncFn(lookup)) {
      lookup = callbackify$3(lookup, (entry) => {
    ...
    function abort(reason) {
      emitter.emit('abort', !reason || reason.type ? new CanceledError$3(null, config, req) : reason);
    }
    ...
    const protocol = parsed.protocol || supportedProtocols$1[0];
    ...
    if (protocol === 'data:') {
      ...
      try {
        convertedData = fromDataURI$1(config.url, responseType === 'blob', {
          Blob: config.env && config.env.Blob
        });
      } catch (err) {
        throw AxiosError$3.from(err, AxiosError$3.ERR_BAD_REQUEST, config);
      }
      ...
      return settle$1(resolve, reject, {
        ...
        status: 200,
        statusText: 'OK',
        headers: new AxiosHeaders$4(),
        config
      });
    }

    if (supportedProtocols$1.indexOf(protocol) === -1) {
      return reject(new AxiosError$3(
    ...
    const headers = AxiosHeaders$4.from(config.headers).normalize();
    ...
    if (utils$1.isSpecCompliantForm(data)) {
      ...
      data = formDataToStream$3(data, (formHeaders) => {
      ...
      data = stream.Readable.from(readBlob$3(data));
    ...
    if (data && (onUploadProgress || maxUploadRate)) {
      ...
      data = stream.pipeline([data, new AxiosTransformStream$3({
    ...
    headers.set(
      'Accept-Encoding',
      'gzip, compress, deflate' + (isBrotliSupported$1 ? ', br' : ''), false
      );
    ...
    const options = {
      ...
      protocol,
      family,
      beforeRedirect: dispatchBeforeRedirect$1,
      beforeRedirects: {}
    };
    ...
    if (config.socketPath) {
      ...
      setProxy$1(options, config.proxy, protocol + '//' + parsed.hostname + (parsed.port ? ':' + parsed.port : '') + options.path);
    }

    let transport;
    const isHttpsRequest = isHttps$1.test(options.protocol);
    ...
    if (config.transport) {
      ...
      transport = isHttpsRequest ? httpsFollow$1 : httpFollow$1;
    }
    ...
    req = transport.request(options, function handleResponse(res) {
      ...
      if (onDownloadProgress) {
        const transformStream = new AxiosTransformStream$3({
      ...
      if (config.decompress !== false && res.headers['content-encoding']) {
        ...
        case 'x-compress':
          ...
          streams.push(zlib.createUnzip(zlibOptions$1));

          // remove the content-encoding in order to not confuse downstream operations
          delete res.headers['content-encoding'];
          break;
        case 'deflate':
          streams.push(new ZlibHeaderTransformStream$3());
          ...
          break;
        case 'br':
          if (isBrotliSupported$1) {
            streams.push(zlib.createBrotliDecompress(brotliOptions$1));
            delete res.headers['content-encoding'];
          }
        }
      }
      ...
      const response = {
        ...
        headers: new AxiosHeaders$4(res.headers),
        config,
        request: lastRequest
      };
      ...
      if (responseType === 'stream') {
        ...
        responseStream.on('data', function handleStreamData(chunk) {
          ...
          if (config.maxContentLength > -1 && totalResponseBytes > config.maxContentLength) {
            ...
            reject(new AxiosError$3('maxContentLength size of ' + config.maxContentLength + ' exceeded',
              AxiosError$3.ERR_BAD_RESPONSE, config, lastRequest));
          }
        });
        ...
        responseStream.on('aborted', function handlerStreamAborted() {
          ...
          const err = new AxiosError$3(
            'maxContentLength size of ' + config.maxContentLength + ' exceeded',
            AxiosError$3.ERR_BAD_RESPONSE,
            config,
            lastRequest
          );
        ...
        responseStream.on('error', function handleStreamError(err) {
          if (req.destroyed) return;
          reject(AxiosError$3.from(err, null, config, lastRequest));
        });
        ...
        responseStream.on('end', function handleStreamEnd() {
          try {
            ...
            reject(AxiosError$3.from(err, null, config, response.request, response));
          }
          settle$1(resolve, reject, response);
        });
      }
    ...
    req.on('error', function handleRequestError(err) {
      ...
      reject(AxiosError$3.from(err, null, config, req));
    });
    ...
    if (config.timeout) {
      ...
      if (Number.isNaN(timeout)) {
        reject(new AxiosError$3(
          ...
          AxiosError$3.ERR_BAD_OPTION_VALUE,
          config,
          req
        ));
    ...
    if (utils$1.isStream(data)) {
      ...
      data.on('close', () => {
        if (!ended && !errored) {
          abort(new CanceledError$3('Request stream has been aborted', config, req));
        }
      });
...
var cookies$1 = platform$1.isStandardBrowserEnv ?
...
var isURLSameOrigin$1 = platform$1.isStandardBrowserEnv ?
...
var xhrAdapter$1 = isXHRAdapterSupported$1 && function (config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    const requestHeaders = AxiosHeaders$4.from(config.headers).normalize();
    ...
    if (platform$1.isStandardBrowserEnv) {
      // Add xsrf header
      const xsrfValue = (config.withCredentials || isURLSameOrigin$1(fullPath))
...
const isResolvedHandle$1 = (adapter) => utils$1.isFunction(adapter) || adapter === null || adapter === false;
...
function dispatchRequest$1(config) {
  ...
  const adapter = adapters$2.getAdapter(config.adapter || defaults$6.adapter);
...
const headersToObject$1 = (thing) => thing instanceof AxiosHeaders$4 ? thing.toJSON() : thing;
...
var CancelToken$5 = CancelToken$4;
...
Object.entries(HttpStatusCode$4).forEach(([key, value]) => {
  HttpStatusCode$4[value] = key;
});

var HttpStatusCode$5 = HttpStatusCode$4;
...
function createInstance$1(defaultConfig) {
  ...
  const instance = bind$3(Axios$4.prototype.request, context);

  // Copy axios.prototype to instance
  utils$1.extend(instance, Axios$4.prototype, context, {allOwnKeys: true});
...
const axios$2 = createInstance$1(defaults$6);

// Expose Axios class to allow class inheritance
axios$2.Axios = Axios$4;

// Expose Cancel & CancelToken
axios$2.CanceledError = CanceledError$3;
axios$2.CancelToken = CancelToken$5;
axios$2.isCancel = isCancel$3;
axios$2.VERSION = VERSION$3;
axios$2.toFormData = toFormData$3;

// Expose AxiosError class
axios$2.AxiosError = AxiosError$3;
...
axios$2.spread = spread$3;

// Expose isAxiosError
axios$2.isAxiosError = isAxiosError$3;

// Expose mergeConfig
axios$2.mergeConfig = mergeConfig$3;

axios$2.AxiosHeaders = AxiosHeaders$4;
...
axios$2.HttpStatusCode = HttpStatusCode$5;
...
const {
  ...
  AxiosHeaders,
  HttpStatusCode: HttpStatusCode$3,
...
const paramsAliasInterceptor$1 = [
  (config) => {
    var _config$method;
    const { params, data, ...rest } = config;
    if (
      ((_config$method = config.method) === null || _config$method === void 0
        ? void 0
        : _config$method.toLowerCase()) === 'get'
    ) {
      const payload = {
        params,
      };
...
const requestInterceptors$1 = [paramsAliasInterceptor$1];
const responseInterceptors$1 = [];
const interceptors$3 = {
  request: requestInterceptors$1,
  response: responseInterceptors$1,
};
function getRewrittenCreate$1(parentInstance) {
  return function create(config, inheritableInterceptors) {
    var _inheritableIntercept,
      _parentInstance$inher,
      _parentInstance$inher2,
      _parentInstance$inher3,
      _parentInstance$inher4,
      _inheritableIntercept2;
    const instance = (parentInstance.axiosCreate || parentInstance.create)(config);
    const interceptors2 = {
      request: [
        ...((_inheritableIntercept =
          inheritableInterceptors === null || inheritableInterceptors === void 0
            ? void 0
            : inheritableInterceptors.request) !== null && _inheritableIntercept !== void 0
          ? _inheritableIntercept
          : []),
        ...((_parentInstance$inher =
          parentInstance === null ||
          parentInstance === void 0 ||
          (_parentInstance$inher2 = parentInstance.inheritableInterceptors) === null ||
          _parentInstance$inher2 === void 0
            ? void 0
            : _parentInstance$inher2.request) !== null && _parentInstance$inher !== void 0
          ? _parentInstance$inher
          : []),
      ],
      response: [
        ...((_parentInstance$inher3 =
          parentInstance === null ||
          parentInstance === void 0 ||
          (_parentInstance$inher4 = parentInstance.inheritableInterceptors) === null ||
          _parentInstance$inher4 === void 0
            ? void 0
            : _parentInstance$inher4.response) !== null && _parentInstance$inher3 !== void 0
          ? _parentInstance$inher3
          : []),
        ...((_inheritableIntercept2 =
          inheritableInterceptors === null || inheritableInterceptors === void 0
            ? void 0
            : inheritableInterceptors.response) !== null && _inheritableIntercept2 !== void 0
          ? _inheritableIntercept2
          : []),
      ],
    };
    const bindInstance = (fn) => (fn ? (payload) => fn(payload, instance) : void 0);
    const use = (key) => {
      interceptors2[key].forEach((interceptor) => {
        const [fulfilled, rejected, ...rest] = interceptor;
        instance.interceptors[key].use(bindInstance(fulfilled), bindInstance(rejected), ...rest);
      });
    };
    use('request');
    use('response');
    instance.inheritableInterceptors = interceptors2;
    instance.axiosCreate = instance.create;
    instance.create = getRewrittenCreate$1(instance);
    return instance
  }
}
function getPropertyDescriptor$1(instance, property) {
  let proto = instance;
  while (proto) {
...
function hideProperty$1(instance, property) {
...
const Fetch$1 = getRewrittenCreate$1(axios$3)(defaults$4, interceptors$3);
Object.setPrototypeOf(Fetch$1, axios$3);
Fetch$1.isFetchError = isAxiosError$2;
Fetch$1.FetchError = AxiosError$2;
Fetch$1.FetchHeaders = AxiosHeaders;
hideProperty$1(Fetch$1, 'AxiosError');
hideProperty$1(Fetch$1, 'isAxiosError');
hideProperty$1(Fetch$1, 'AxiosHeaders');
Object.defineProperty(Fetch$1, 'default', getPropertyDescriptor$1(axios$3, 'default'));
axios$3.CancelToken;
axios$3.Cancel;
...
var getBuiltInPrototypeMethod$2 = function (CONSTRUCTOR, METHOD) {
  ...
  var NativeConstructor = globalThis$2[CONSTRUCTOR];
...
var _sortInstanceProperty = /*@__PURE__*/getDefaultExportFromCjs$1(sort);
...
const fetchBase$1 = (path, params, config) => {
  return Promise.all([getPlatformAPIHost(), getInstanceId()]).then((_ref) => {
    ...
    if (error instanceof AxiosError$2) {
      const $error = error;
...
var reduce$3 = getBuiltInPrototypeMethod('Array', 'reduce');
...
var _reduceInstanceProperty = /*@__PURE__*/getDefaultExportFromCjs$1(reduce);
...
const defaults$1$1 = {
  ...
  transformResponse: [function transformResponse(data) {
    const transitional2 = this.transitional || defaults$1$1.transitional;
...
utils.forEach(["delete", "get", "head", "post", "put", "patch"], (method) => {
  defaults$1$1.headers[method] = {};
});
const defaults$2 = defaults$1$1;
...
const knownAdapters = {
  http: isHttpAdapterSupported && httpAdapter$1,
...
axios.CancelToken = CancelToken$3;
...
const requestInterceptors = [paramsAliasInterceptor];
const responseInterceptors = [];
const interceptors$2 = {
  request: requestInterceptors,
  response: responseInterceptors
};
function getRewrittenCreate(parentInstance) {
  return function create(config, inheritableInterceptors) {
    var _inheritableIntercept, _parentInstance$inher, _parentInstance$inher2, _parentInstance$inher3, _parentInstance$inher4, _inheritableIntercept2;
    const instance = (parentInstance.axiosCreate || parentInstance.create)(config);
    const interceptors2 = {
      request: [
        ...(_inheritableIntercept = inheritableInterceptors === null || inheritableInterceptors === void 0 ? void 0 : inheritableInterceptors.request) !== null && _inheritableIntercept !== void 0 ? _inheritableIntercept : [],
        ...(_parentInstance$inher = parentInstance === null || parentInstance === void 0 || (_parentInstance$inher2 = parentInstance.inheritableInterceptors) === null || _parentInstance$inher2 === void 0 ? void 0 : _parentInstance$inher2.request) !== null && _parentInstance$inher !== void 0 ? _parentInstance$inher : []
      ],
      response: [
        ...(_parentInstance$inher3 = parentInstance === null || parentInstance === void 0 || (_parentInstance$inher4 = parentInstance.inheritableInterceptors) === null || _parentInstance$inher4 === void 0 ? void 0 : _parentInstance$inher4.response) !== null && _parentInstance$inher3 !== void 0 ? _parentInstance$inher3 : [],
        ...(_inheritableIntercept2 = inheritableInterceptors === null || inheritableInterceptors === void 0 ? void 0 : inheritableInterceptors.response) !== null && _inheritableIntercept2 !== void 0 ? _inheritableIntercept2 : []
      ]
    };
    const bindInstance = (fn) => fn ? (payload) => fn(payload, instance) : void 0;
    const use = (key) => {
    ...
    instance.inheritableInterceptors = interceptors2;
    instance.axiosCreate = instance.create;
    instance.create = getRewrittenCreate(instance);
    return instance;
  };
}
function getPropertyDescriptor(instance, property) {
  let proto = instance;
  while (proto) {
    const descriptor = Object.getOwnPropertyDescriptor(proto, property);
    if (descriptor) {
...
function hideProperty(instance, property) {
  Object.defineProperty(instance, property, {
    value: void 0,
    writable: true,
    configurable: true,
...
const Fetch = getRewrittenCreate(axios$1)(defaults$3, interceptors$2);
Object.setPrototypeOf(Fetch, axios$1);
Fetch.isFetchError = isAxiosError;
Fetch.FetchError = AxiosError;
Fetch.FetchHeaders = AxiosHeaders2;
hideProperty(Fetch, "AxiosError");
hideProperty(Fetch, "isAxiosError");
hideProperty(Fetch, "AxiosHeaders");
Object.defineProperty(Fetch, "default", getPropertyDescriptor(axios$1, "default"));
axios$1.CancelToken;
axios$1.Cancel;
...
function setProxy(options, configProxy, location) {
  ...
  if (!proxy && proxy !== false) {
    ...
    if (proxyUrl) {
      proxy = new require$$0$1.URL(proxyUrl);
    }
  }
  if (proxy) {
    if (proxy.username) {
...
function httpAdapter(config) {
  return wrapAsync(async function dispatchHttpRequest(resolve, reject, onDone) {
    ...
    const fullPath = buildFullPath(config.baseURL, config.url);
    const parsed = new require$$0$1.URL(fullPath, "http://localhost");
...
function getResponseType(headers) {
  const fullContentType = headers.getContentType() || "";
  const contentType = fullContentType.split(";")[0];
  return ResponseTypeMap[contentType] || "unknown";
}
const getTextDecoder = ((cache) => (encoding) => {
  return cache[encoding] || (cache[encoding] = new TextDecoder(encoding));
})(/* @__PURE__ */ Object.create(null));
const getTextEncoder = ((cache) => () => {
  return cache;
})(new TextEncoder());
...
function parseAuthorizationHeader(config) {
  var _config$headers;
  const token = (_config$headers = config.headers) === null || _config$headers === void 0 ? void 0 : _config$headers.Authorization;
  return typeof token === "string" ? token.replace(/^Bearer /, "") : void 0;
}
const DEFAULT_BASE_URL = "http://127.0.0.1:9001";
const SUPPORTED_PROTOCOL_SET = /* @__PURE__ */ new Set(["http:", "https:"]);
const NOT_TRANSFORM_RESPONSE_TYPE_SET = /* @__PURE__ */ new Set(["arraybuffer", "unknown"]);
function pluginNodeAdapter(config) {
  const {
    promise,
    resolve,
    reject
  ...
  function abort(reason) {
    reject(!reason || reason !== null && reason !== void 0 && reason.type ? new CanceledError(null, config) : reason);
  }
  if (config.cancelToken || config.signal) {
    var _config$cancelToken;
    (_config$cancelToken = config.cancelToken) === null || _config$cancelToken === void 0 || _config$cancelToken.subscribe(abort);
    if (config.signal) {
      config.signal.aborted ? abort() : config.signal.addEventListener("abort", abort);
    }
  }
  async function handleFetch() {
    var _global2, _options$method, _responsePlatformMess, _responseMessage$Body, _responseMessage$Erro;
    const {
      method,
      headers,
    ...
    const fullPath = buildFullPath(config.baseURL, config.url);
    const parsed = new require$$0$1.URL(fullPath, DEFAULT_BASE_URL);
    const _Fetch = (_global2 = global) === null || _global2 === void 0 || (_global2 = _global2.onesEnv) === null || _global2 === void 0 ? void 0 : _global2._Fetch;
    if (utils.kindOf(_Fetch) !== "function") {
      throw new AxiosError("global.onesEnv._Fetch not found", AxiosError.ERR_NOT_SUPPORT, config);
    }
    if (!SUPPORTED_PROTOCOL_SET.has(parsed.protocol)) {
      throw new AxiosError("Unsupported protocol " + parsed.protocol, AxiosError.ERR_BAD_REQUEST, config);
    }
    if (timeout && isNaN(timeout)) {
      throw new AxiosError("Error trying to parse `config.timeout` to int", AxiosError.ERR_BAD_OPTION_VALUE, config);
    }
    if (utils.isFormData(data) && utils.isFunction(data.getBuffer) && utils.isFunction(data.getHeaders)) {
      headers.set(data.getHeaders());
      data = new Uint8Array(Buffer.from(data.getBuffer()));
      if (!headers.hasContentLength()) {
        try {
          const knownLength = await require$$1.promisify(data.getLength).call(data);
          Number.isFinite(knownLength) && knownLength >= 0 && headers.setContentLength(knownLength);
      ...
      if (utils.isArrayBuffer(data)) {
        ...
        data = getTextEncoder().encode(data);
      } else {
        throw new AxiosError("Data after transformation must be a string, an ArrayBuffer or a Buffer,", AxiosError.ERR_BAD_REQUEST, config);
      }
      headers.setContentLength(data.length, false);
    ...
    try {
      ...
      const customErr = new Error(err === null || err === void 0 ? void 0 : err.message);
      customErr.config = config;
      customErr.url = config.url;
      customErr.exists = true;
      throw customErr;
    ...
    const requestPlatformMessage = {
      Resource: {
        Http: {
          ResourceType: 0,
          ResourceHttpRequest: {
            Headers: formatHeaders(options.headers),
            Url: buildFullPath(options.origin, options.path),
            // 必须大写，否则 404
            Method: (_options$method = options.method) === null || _options$method === void 0 ? void 0 : _options$method.toUpperCase(),
            Body: data,
            Root: root,
            TeamUUID: teamUUID
          }
    ...
    let responsePlatformMessage;
    try {
      responsePlatformMessage = await _Fetch(requestPlatformMessage, "Resource", timeout);
    } catch (e) {
      if (e instanceof Error && e.message === "timeout") {
        ...
        throw new AxiosError(timeoutErrorMessage, transitional2 !== null && transitional2 !== void 0 && transitional2.clarifyTimeoutError ? AxiosError.ETIMEDOUT : AxiosError.ECONNABORTED, config);
      }
      throw AxiosError.from(e, void 0, config, requestPlatformMessage);
    }
    const responseMessage = (_responsePlatformMess = responsePlatformMessage.Resource) === null || _responsePlatformMess === void 0 || (_responsePlatformMess = _responsePlatformMess.Http) === null || _responsePlatformMess === void 0 ? void 0 : _responsePlatformMess.ResourceHttpResponse;
    if (!responseMessage) {
      throw new AxiosError("Invalid response message", AxiosError.ERR_BAD_RESPONSE, config);
    }
    const totalResponseBytes = ((_responseMessage$Body = responseMessage.Body) === null || _responseMessage$Body === void 0 ? void 0 : _responseMessage$Body.length) || 0;
    if (maxContentLength > -1 && totalResponseBytes > maxContentLength) {
      throw new AxiosError("maxContentLength size of " + maxContentLength + " exceeded", AxiosError.ERR_BAD_RESPONSE, config, requestPlatformMessage);
    }
    const status = Number(((_responseMessage$Erro = responseMessage.Error) === null || _responseMessage$Erro === void 0 ? void 0 : _responseMessage$Erro.Code) || responseMessage.StatusCode);
    const response = {
      status,
      statusText: HttpStatusCode[status] || "Unknown Status",
      headers: parseHeaders(responseMessage.Headers),
      config,
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      data: responseMessage.Body,
      originalMessage: responsePlatformMessage
    };
    const responseType = config.responseType || getResponseType(AxiosHeaders2.from(response.headers));
    try {
      if (responseMessage.Body && !NOT_TRANSFORM_RESPONSE_TYPE_SET.has(responseType)) {
        if (responseType === "text") {
          response.data = getTextDecoder(responseEncoding).decode(responseMessage.Body);
        } else if (responseType === "json") {
          const jsonStr = getTextDecoder(responseEncoding).decode(responseMessage.Body);
          response.data = JSON.parse(jsonStr);
        } else if (responseType === "stream" || responseType === "blob") {
          throw new AxiosError(`Unsupported response type: ${responseType}`, AxiosError.ERR_NOT_SUPPORT, response.config, requestPlatformMessage, response);
        }
      }
    } catch (e) {
      if (e instanceof Error && e.name === "SyntaxError") {
        throw AxiosError.from(e, AxiosError.ERR_BAD_RESPONSE, config, requestPlatformMessage, response);
      }
      throw e;
    }
    if (!(validateStatus2 !== null && validateStatus2 !== void 0 && validateStatus2(response.status))) {
      throw new AxiosError("Request failed with status code " + response.status, [AxiosError.ERR_BAD_REQUEST, AxiosError.ERR_BAD_RESPONSE][Math.floor(response.status / 100) - 4], response.config, requestPlatformMessage, response);
    }
    return response;
  }
  handleFetch().then(resolve, reject);
  return promise;
}
function formatHeaders(headers) {
  var _context;
  return _reduceInstanceProperty(_context = Object.entries(headers)).call(_context, (acc, _ref) => {
    let [k, v] = _ref;
...
function parseHeaders(headers) {
  ...
  if (!headers)
    return {};
  return _reduceInstanceProperty(_context2 = Object.keys(headers)).call(_context2, (acc, key) => {
    var _headers$key;
    const val = (_headers$key = headers[key]) === null || _headers$key === void 0 ? void 0 : _headers$key.val;
    if (val) {
      acc[key] = val.join(", ");
    }
    return acc;
...
var AdapterType = /* @__PURE__ */ ((AdapterType2) => {
  AdapterType2["http"] = "http";
  AdapterType2["pluginNode"] = "pluginNode";
  AdapterType2["xhr"] = "xhr";
  return AdapterType2;
})(AdapterType || {});
const adapters = {
  [AdapterType.http]: httpAdapter,
  [AdapterType.pluginNode]: pluginNodeAdapter
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
};

function Unit8Array2String(arrayBuffer) {
  return new TextDecoder("utf-8").decode(arrayBuffer);
}
function Unit8Array2Object(arrayBuffer) {
  const str = Unit8Array2String(arrayBuffer);
  return str ? JSON.parse(str) : {};
}

class InternalAbilityError extends Error {
  constructor(level, errcode, statusCode, reason) {
    super();
    this.errType = "abilityError";
    this.errcode = errcode;
    this.level = level;
    this.statusCode = statusCode;
    this.model = "plugin.Err";
    this.reason = reason;
  }
}
function ConvertPbErrToAbilityErr(err) {
  const level = (err === null || err === void 0 ? void 0 : err.Level) || "error";
  const errcode = (err === null || err === void 0 ? void 0 : err.Error) || "ServerError";
  const reason = err === null || err === void 0 ? void 0 : err.Msg;
  const statusCode = err === null || err === void 0 ? void 0 : err.Code;
  const abilityErr = new InternalAbilityError(level, errcode, statusCode, reason);
  if (err.Ext != null) {
    const ext = Unit8Array2Object(err.Ext);
    for (const key in ext) {
      abilityErr[key] = ext[key];
    }
  }
  return abilityErr;
}

const isVm2Node = typeof process === "object" && (typeof window === "undefined" || utils.kindOf(window) !== "window");
const isNode = typeof process !== "undefined" && utils.kindOf(process) === "process" || isVm2Node;
const isPluginNode = utils.kindOf(_globalThis === null || _globalThis === void 0 ? void 0 : _globalThis.onesEnv) === "object" && isNode;
function isPluginNodeRequest(config) {
  const fullPath = buildFullPath(config.baseURL, config.url);
  return isPluginNode && !isAbsoluteURL(fullPath);
}
function getAdapterType(config) {
  if (isNode) {
    if (isPluginNodeRequest(config)) {
      return AdapterType.pluginNode;
    }
    return AdapterType.http;
  }
  return AdapterType.xhr;
}
const checkAdapterTypeSupport = ((cache) => (type) => {
  if (cache[type] !== void 0) {
    return cache[type];
  }
  if (type === AdapterType.pluginNode) {
    return cache[type] = isPluginNode;
  }
  if (type === AdapterType.http) {
    return cache[type] = isNode;
  }
  if (type === AdapterType.xhr) {
    return cache[type] = typeof XMLHttpRequest !== "undefined";
  }
})(/* @__PURE__ */ Object.create(null));
function adapter(config) {
  var _config$transitional;
  if (Object.values(adapters).length === 0) {
    throw new AxiosError("No supported adapter found, please check your environment", AxiosError.ERR_NOT_SUPPORT, config);
  }
  const type = getAdapterType(config);
  const _adapter = adapters[type];
  if (!_adapter || !checkAdapterTypeSupport(type)) {
    throw new AxiosError(`No supported adapter found for type "${type}", please check your environment`, AxiosError.ERR_NOT_SUPPORT, config);
  }
  if (type === AdapterType.pluginNode && (_config$transitional = config.transitional) !== null && _config$transitional !== void 0 && _config$transitional.forcedJSONParsing) {
...
if (typeof window !== "undefined") {
  var _window$__ONES_MF_ENV, _window$__ONES_MF_ENV2;
  commonHeaders = (_window$__ONES_MF_ENV = (_window$__ONES_MF_ENV2 = window.__ONES_MF_ENV__) === null || _window$__ONES_MF_ENV2 === void 0 || (_window$__ONES_MF_ENV2 = _window$__ONES_MF_ENV2.request) === null || _window$__ONES_MF_ENV2 === void 0 ? void 0 : _window$__ONES_MF_ENV2.headers) !== null && _window$__ONES_MF_ENV !== void 0 ? _window$__ONES_MF_ENV : {};
}
const defaults$1 = {
...
const pluginNodeErrorHandlerInterceptor = [(r) => r, (error) => {
  var _global$onesEnv, _error$response;
  const _Logger = (_global$onesEnv = global.onesEnv) === null || _global$onesEnv === void 0 ? void 0 : _global$onesEnv._Logger;
  if (error !== null && error !== void 0 && (_error$response = error.response) !== null && _error$response !== void 0 && (_error$response = _error$response.data) !== null && _error$response !== void 0 && _error$response.desc) {
    _Logger === null || _Logger === void 0 || _Logger.error(error.response.data.desc);
  }
  throw error;
}];
const _interceptors$1 = {
  request: [],
...
const abilityErrorHandler = [(r) => r, (error) => {
  var _error$response, _originalMessage$Reso, _global$onesEnv, _responseMessage$Erro;
  const originalMessage = (_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.originalMessage;
  const isPluginNodeFetchResponse = !!originalMessage;
  const responseMessage = originalMessage === null || originalMessage === void 0 || (_originalMessage$Reso = originalMessage.Resource) === null || _originalMessage$Reso === void 0 || (_originalMessage$Reso = _originalMessage$Reso.Http) === null || _originalMessage$Reso === void 0 ? void 0 : _originalMessage$Reso.ResourceHttpResponse;
  if (!isPluginNodeFetchResponse || !responseMessage) {
    throw error;
  }
  const _Logger = (_global$onesEnv = global.onesEnv) === null || _global$onesEnv === void 0 ? void 0 : _global$onesEnv._Logger;
  if (((_responseMessage$Erro = responseMessage.Error) === null || _responseMessage$Erro === void 0 ? void 0 : _responseMessage$Erro.Model) === "plugin.Err") {
    const abilityErr = ConvertPbErrToAbilityErr(responseMessage.Error);
    _Logger === null || _Logger === void 0 || _Logger.warning("[Ability Error]: ", abilityErr.errcode, abilityErr.reason, abilityErr.level, abilityErr.statusCode);
    const fetchAbilityErr = new AbilityError(abilityErr.level, abilityErr.errcode, abilityErr.statusCode, abilityErr.reason);
    fetchAbilityErr.message = abilityErr.reason;
    fetchAbilityErr.config = error.config;
    fetchAbilityErr.request = error.request;
    fetchAbilityErr.response = error.response;
    fetchAbilityErr.cause = error;
    throw fetchAbilityErr;
  }
  throw error;
}];
const defaults = {};
...
class LoadingManage {
  ...
  waiting() {
    if (this.loadingPromise === null) {
      this.isLoading = true;
      this.loadingPromise = this.loadingFn(this.token).then((token) => {
        this.token = token;
        return token;
      }).catch((e2) => {
        this.loadingPromise = null;
...
function createOauth2Interceptor(getLoadingManage2) {
  const request = [(config) => {
    return getLoadingManage2(config).waiting().then((token) => {
      if (!config.headers) {
        config.headers = {};
      }
  ...
  const response = [
    ...
    function(error, instance) {
      ...
      if (((_error$response = error.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.errorCode) === "NotActive" && config) {
        var _instance;
        const token = parseAuthorizationHeader(config);
        getLoadingManage2(config).clear(token);
        return (_instance = instance === null || instance === void 0 ? void 0 : instance(config)) !== null && _instance !== void 0 ? _instance : Promise.reject(error);
      }
      return Promise.reject(error);
    }
  ];
...
function buildOrgOrTeamInfo(orgID, teamID) {
  if (orgID) {
    return {
      ID: orgID,
      type: "org"
...
function parseOrgOrTeamUUIDInConfig(config) {
  var _config$params, _config$params2;
  const uuidFromParamsInConfig = buildOrgOrTeamInfo((_config$params = config.params) === null || _config$params === void 0 ? void 0 : _config$params.organizationID, (_config$params2 = config.params) === null || _config$params2 === void 0 ? void 0 : _config$params2.teamID);
  if (uuidFromParamsInConfig) {
    return uuidFromParamsInConfig;
  }
  const searchParams = new require$$0$1.URL(config.url || "", "http://localhost").searchParams;
  const uuidFromSearchParamsInConfig = buildOrgOrTeamInfo(searchParams.get("organizationID") || void 0, searchParams.get("teamID") || void 0);
  if (uuidFromSearchParamsInConfig) {
    return uuidFromSearchParamsInConfig;
  }
  const uuidFromONESConfig = buildOrgOrTeamInfo(void 0, config.teamUUID);
  if (uuidFromONESConfig) {
    return uuidFromONESConfig;
  }
  throw new Error("teamUUID or organizationUUID is required in the config.");
}
const loadingCacheWithUUID = /* @__PURE__ */ new Map();
const interceptors = createOauth2Interceptor((config) => {
  const uuidConfig = parseOrgOrTeamUUIDInConfig(config);
  let loadingManageFromCache = loadingCacheWithUUID.get(uuidConfig.ID);
  if (!loadingManageFromCache) {
    loadingManageFromCache = new LoadingManage(() => {
      return AbilityFetch({
        url: "",
        method: "POST",
        headers: {
          "AbilityName": "Oauth2AdminToken",
          "Ones-Plugin-Id": "built_in_apis"
        },
        data: {
          team_uuid: uuidConfig.type === "team" ? uuidConfig.ID : void 0,
          organization_uuid: uuidConfig.type === "org" ? uuidConfig.ID : void 0,
          instance_id: _globalThis.onesEnv.instanceId
        },
        responseType: "json"
      }).then((response) => {
        var _response$data;
        return response === null || response === void 0 || (_response$data = response.data) === null || _response$data === void 0 || (_response$data = _response$data.data) === null || _response$data === void 0 ? void 0 : _response$data.access_token;
      });
    });
    loadingCacheWithUUID.set(uuidConfig.ID, loadingManageFromCache);
  }
  return loadingManageFromCache;
});
function getLoadingManage$1(config) {
  const uuid = (config === null || config === void 0 ? void 0 : config.organizationID) || (config === null || config === void 0 ? void 0 : config.teamID);
  if (!uuid) {
    throw new Error("teamUUID or organizationUUID is required in the config.");
  }
  const loadingManage = loadingCacheWithUUID.get(uuid);
  if (!loadingManage) {
    throw new Error("loadingManage not found");
  }
  return loadingManage;
}
const _interceptors = {
  interceptors,
  getLoadingManage: getLoadingManage$1
};
const oauth2Interceptors = _interceptors.interceptors;
const getLoadingManage = _interceptors.getLoadingManage;
function getOpenApiTokenWithChecker(loadingManage, fetch) {
  return loadingManage.waiting().then((token) => {
    return fetch("/oauth2/introspect", {
      headers: {
        Authorization: `Bearer ${token}`
      }
    }).then((info) => {
      if (!info.data.active) {
        loadingManage.clear(token);
      }
      return loadingManage.waiting();
    });
  });
}
const baseUrlFetch = OPFetch$1.create(defaults$1, {
  request: [[(config) => {
    ...
    if (baseUrl && !isAbsoluteURL(baseUrlFromConfig)) {
      const origin = new require$$0$1.URL(baseUrl).origin;
      config.baseURL = origin + baseUrlFromConfig;
    }
    return config;
  }]]
});
const oauth2Fetch = baseUrlFetch.create(defaults$1, oauth2Interceptors);
function getOpenApiToken$1(config) {
  return getOpenApiTokenWithChecker(getLoadingManage(config), baseUrlFetch);
}
const fetchOpenApi = baseUrlFetch.create(defaults$1, {
  request: [[(config) => {
    var _config$headers;
    if (!((_config$headers = config.headers) !== null && _config$headers !== void 0 && _config$headers.Authorization)) {
      throw new Error("Authorization is required in the headers.");
    }
    return config;
  }]]
});
...
const key = (teamUUID) => `team_${teamUUID}`;
